...
| [`netplay/10-session-handover.md`](netplay/10-session-handover.md) | **Start here with a PC.** Build, deploy, the four playtest runs, the log lines to grep, and what each result decides |
