...
namespace MegabonkTogether.Services
{
    ...
    public class LocalizationService : ILocalizationService
    {
        public readonly Dictionary<(string, string), string> LocalizationOverrides = new()
        {
            ...
            { ("MegabonkTogether", "IncompatibleVersion"), "Incompatible version" },
            { ("MegabonkTogether", "IncompatibleVersion_UpdateYours"), "Your MegabonkTogether is out of date. Update to play with this lobby." },
            { ("MegabonkTogether", "IncompatibleVersion_UpdateTheirs"), "That lobby is running an older MegabonkTogether. They need to update." },
